...
typedef struct {
    ...
    FoodData foodActionData[10];
    // expiredFoodData ExpiredFoodActionData[10];
    // expiredFoodData willExpiredFoodActionData[10];
    int detectActionStatus;
    ...
    const char *subDeviceActionFood;
    // const char *subDeviceActionFood_Expired;
    // const char *subDeviceActionFood_willExpired;
    const char *subDeviceActionDetect;
